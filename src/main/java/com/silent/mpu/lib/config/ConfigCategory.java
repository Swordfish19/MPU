...
//import static net.minecraftforge.lib.config.Configuration.COMMENT_SEPARATOR;
//import static net.minecraftforge.lib.config.Configuration.NEW_LINE;
//import static net.minecraftforge.lib.config.Configuration.allowedProperties;
